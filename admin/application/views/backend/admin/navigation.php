    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
                ...
                <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-home p-r-10"></i> <span
                            class="hide-menu"><?php echo get_phrase('home');?><span
                    ...
                    <ul class="nav nav-second-level<?php
                        ...
                        <li class="<?php if ($page_name == 'manage_slider') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/manage_slider">
                                ...
                                <span class="hide-menu"><?php echo get_phrase('Add Slider'); ?></span>
                            </a>
                        </li>
                        ...
                        <li class="<?php if ($page_name == 'courses') echo 'active'; ?> ">
                            ...
                            <i class="fa fa-angle-double-right p-r-10"></i>
                            <span class="hide-menu"><?php echo get_phrase('Courses'); ?></span>
                            </a>
                        </li>

                        <li class="<?php if ($page_name == 'announcement') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/announcement">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Add Announcement'); ?></span>
                            </a>
                        </li>

                        <li class="<?php if ($page_name == 'results') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/results">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Add Results'); ?></span>
                            </a>
                        </li>

                        <li class="<?php if ($page_name == 'meet_our_winners') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/meet_our_winners">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Add Winners'); ?></span>
                            </a>
                        </li>

                        <li class="<?php if ($page_name == 'manage_gallery') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/manage_gallery">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Add Gallery'); ?></span>
                            </a>
                        </li>

                         <li class="<?php if ($page_name == 'manage_classroom') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/manage_classroom">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Add Classroom'); ?></span>
                            </a>
                        </li>

                        <li class="<?php if ($page_name == 'manage_testimonial') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/manage_testimonial">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Add Testimonial'); ?></span>
                            </a>
                        </li>
                ...
                <!---  Permission for Admin Manage Meeting starts here ------>
                <?php $check_admin_permission = $this->db->get_where('admin_role', array('admin_id' => $this->session->userdata('login_user_id')))->row()->manage_meeting;?>
                <?php if($check_admin_permission == '1'):?>

                <li class="staff"> <a href="javascript:void(0);" class="waves-effect"><i data-icon="&#xe006;"
                            class="fa fa-link p-r-10"></i> <span
                            class="hide-menu"><?php echo get_phrase('Manage Lecture');?><span
                                class="fa arrow"></span></span></a>

                    <ul class="nav nav-second-level<?php if ($page_name == 'manage_meeting')echo 'opened active';?> ">

                        <li class="<?php if ($page_name == 'manage_meeting') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/manage_meeting">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Meeting'); ?></span>
                            </a>
                        </li>
                        <li class="<?php if ($page_name == 'manage_recorded_lecture') echo 'active'; ?> ">
                            <a href="<?php echo base_url(); ?>admin/manage_recorded_lecture">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Recorded Lecture'); ?></span>
                            </a>
                        </li>
                    </ul>
                </li>
                <?php endif;?>
                <!---  Permission for Admin Manage Meeting ends here ------>
                ...
                <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-mortar-board" data-icon="7"></i>
                        <span class="hide-menu"> <?php echo get_phrase('Quiz Management');?> <span
                                class="fa arrow"></span></span></a>
                    <ul class=" nav nav-second-level<?php
                ...
                <?php if($check_admin_permission == '1'):?>
                <li style="display:none;"> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-mortar-board" data-icon="7"></i>
            ...
            ?>">
                ...
                <li> <a href="#" class="waves-effect"><i data-icon="&#xe006;" class="fa fa-bar-chart-o p-r-10"></i>
                        <span class="hide-menu"><?php echo get_phrase('student_scores');?><span
                                class="fa arrow"></span></span></a>
            ...
            ?>">
                ...
                <li> <a href="#" class="waves-effect d-none"><i data-icon="&#xe006;" class="fa fa-university p-r-10"></i> <span
            ...
            ?>">
                ...
                <li> <a href="#" class="waves-effect d-none"><i data-icon="&#xe006;" class="fa fa-car p-r-10"></i> <span
