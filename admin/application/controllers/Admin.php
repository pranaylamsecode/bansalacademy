...
class Admin extends CI_Controller {
    ...
    /***********  The function manages meeting link ***********************/
    function manage_meeting ($param1 = null, $param2 = null, $param3 = null){

        if($param1 == 'create'){
            // echo 'hello';
            $this->meeting_model->createMeetingLink();
            $this->session->set_flashdata('flash_message', get_phrase('Data saved successfully'));
            redirect(base_url(). 'admin/manage_meeting', 'refresh');
        }

        if($param1 == 'update'){
            $this->meeting_model->updateMeetingLink($param2);
            $this->session->set_flashdata('flash_message', get_phrase('Data updated successfully'));
            redirect(base_url(). 'admin/manage_meeting', 'refresh');
        }
        ...
        if($param1 == 'delete'){
            // print_r($param2);
            // exit;
            $this->meeting_model->deleteMeetingLink($param2);
            $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
            redirect(base_url(). 'admin/manage_meeting', 'refresh');
        }

        $page_data['page_name']     = 'manage_meeting';
        $page_data['page_title']    = get_phrase('Manage Meeting');
        $this->load->view('backend/index', $page_data);
       ...
       /***********  The function manages meeting link ***********************/
       function manage_recorded_lecture ($param1 = null, $param2 = null, $param3 = null){
        ...
        $page_data['page_name']     = 'manage_recorded_lecture';
        $page_data['page_title']    = get_phrase('Recoreded Lecture');
        $this->load->view('backend/index', $page_data);

    }

        /***********  The function manages meeting link ***********************/
        function manage_slider ($param1 = null, $param2 = null, $param3 = null){

            if ($param1 == 'upload_logo')
            {
               $this->home_model->system_logo();
               $this->session->set_flashdata('flash_message', get_phrase('slider_updated'));
               redirect(base_url() . 'admin/manage_slider', 'refresh');
            }

            if($param1 == 'delete_slide'){
                // print_r($param2);
                // exit;
                $this->home_model->deleteSlider($param2);
                $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
                redirect(base_url(). 'admin/manage_slider', 'refresh');
            }

            $page_data['page_name']     = 'manage_slider';
            $page_data['page_title']    = get_phrase('Manage Slider');
            $this->load->view('backend/index', $page_data);

        }

        function results ($param1 = null, $param2 = null, $param3 = null){

            if ($param1 == 'result_image')
            {
               $this->home_model->result_image();
               $this->session->set_flashdata('flash_message', get_phrase('result_updated'));
               redirect(base_url() . 'admin/results', 'refresh');
            }

            if($param1 == 'delete_result'){
                // print_r($param2);
                // exit;
                $this->home_model->deleteResult($param2);
                $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
                redirect(base_url(). 'admin/results', 'refresh');
            }

            $page_data['page_name']     = 'results';
            $page_data['page_title']    = get_phrase('Manage Results');
            $this->load->view('backend/index', $page_data);
        ...
        function courses ($param1 = null, $param2 = null, $param3 = null){
            ...
            if ($param1 == 'create')
            {
                // print_r($param1);
                // exit;
               $this->home_model->createCourse();
               $this->session->set_flashdata('flash_message', get_phrase('Data Added'));
               redirect(base_url() . 'admin/courses', 'refresh');
            }

            if($param1 == 'delete_course'){
                // print_r($param2);
                // exit;
                $this->home_model->deleteCourse($param2);
                $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
                redirect(base_url(). 'admin/courses', 'refresh');
            }

            $page_data['page_name']     = 'courses';
            $page_data['page_title']    = get_phrase('Manage Courses');
            $this->load->view('backend/index', $page_data);

        }

        function announcement ($param1 = null, $param2 = null, $param3 = null){

            if ($param1 == 'create_announcement')
            {
                // print_r($param1);
                // exit;
               $this->home_model->createAnnouncement();
               $this->session->set_flashdata('flash_message', get_phrase('Data Added'));
               redirect(base_url() . 'admin/announcement', 'refresh');
            }

            if($param1 == 'delete_announcement'){
                // print_r($param2);
                // exit;
                $this->home_model->deleteAnnouncement($param2);
                $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
                redirect(base_url(). 'admin/announcement', 'refresh');
            }

            $page_data['page_name']     = 'announcement';
            $page_data['page_title']    = get_phrase('Manage Announcement');
            $this->load->view('backend/index', $page_data);
        ...
        function meet_our_winners ($param1 = null, $param2 = null, $param3 = null){
            ...
            if ($param1 == 'create_winners')
            {
                // print_r($param1);
                // exit;
               $this->home_model->createWinners();
               $this->session->set_flashdata('flash_message', get_phrase('Data Added'));
               redirect(base_url() . 'admin/meet_our_winners', 'refresh');
            }

            if($param1 == 'delete_winners'){
                // print_r($param2);
                // exit;
                $this->home_model->deleteWinners($param2);
                $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
                redirect(base_url(). 'admin/meet_our_winners', 'refresh');
            }

            $page_data['page_name']     = 'meet_our_winners';
            $page_data['page_title']    = get_phrase('Manage Winners');
            $this->load->view('backend/index', $page_data);

        }

        function manage_gallery ($param1 = null, $param2 = null, $param3 = null){

            if ($param1 == 'create_gallery')
            {
                // print_r($param1);
                // exit;
               $this->home_model->createGallery();
               $this->session->set_flashdata('flash_message', get_phrase('Data Added'));
               redirect(base_url() . 'admin/manage_gallery', 'refresh');
            }

            if($param1 == 'delete_gallery'){
                // print_r($param2);
                // exit;
                $this->home_model->deleteGallery($param2);
                $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
                redirect(base_url(). 'admin/manage_gallery', 'refresh');
            }

            $page_data['page_name']     = 'manage_gallery';
            $page_data['page_title']    = get_phrase('Manage Gallery');
            $this->load->view('backend/index', $page_data);

        }

        function manage_classroom ($param1 = null, $param2 = null, $param3 = null){

            if ($param1 == 'create_classroom')
            {
                // print_r($param1);
                // exit;
               $this->home_model->createClassroom();
               $this->session->set_flashdata('flash_message', get_phrase('Data Added'));
               redirect(base_url() . 'admin/manage_classroom', 'refresh');
            }

            if($param1 == 'delete_classroom'){
                // print_r($param2);
                // exit;
                $this->home_model->deleteClassroom($param2);
                $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
                redirect(base_url(). 'admin/manage_classroom', 'refresh');
            }

            $page_data['page_name']     = 'manage_classroom';
            $page_data['page_title']    = get_phrase('Manage Classroom');
            $this->load->view('backend/index', $page_data);

        }

        function manage_testimonial ($param1 = null, $param2 = null, $param3 = null){

            if ($param1 == 'create_testimonial')
            {
                // print_r($param1);
                // exit;
               $this->home_model->createTestimonial();
               $this->session->set_flashdata('flash_message', get_phrase('Data Added'));
               redirect(base_url() . 'admin/manage_testimonial', 'refresh');
            }

            if($param1 == 'delete_testimonial'){
                // print_r($param2);
                // exit;
                $this->home_model->deleteTestimonial($param2);
                $this->session->set_flashdata('flash_message', get_phrase('Data deleted successfully'));
                redirect(base_url(). 'admin/manage_testimonial', 'refresh');
            }

            $page_data['page_name']     = 'manage_testimonial';
    ...
    function csvImportQuestion(){



        $page_data['page_name']     = 'csv_import';
        $page_data['page_title']    = get_phrase('Csv Import');
        $this->load->view('backend/index', $page_data);
    }
